...
# from env.minigrid_neverdone_no_inner_reward import MiniGrid_fourroom_obs8x8
from env.find_ball import FindBall

# from pfc.gru_pred_conv_8x8 import GruPredHid
from pfc.gru_pfc_minigrid_discrete import PPO_GRU_Module
...
def main():
    ...
    input_output_info={
        ...
        'obs_dim':env.obs_dim,
        'action_env_dim':env.action_dim_discrete,
        'action_dim':env.action_dim_discrete,
        'actor_gru_hid_dim':256,
        'critic_gru_hid_dim':256
        }
    ...
    # pfc_train.load_model('all_models/pfc_model',3420)
