...
from pfc.hyperparam.dppo_gru_hybrid_hp import DPPO_Hybrid_HyperParam as hp
import gym
import copy
import time
...
def dppo_learn_process(queue_dict):
    ...
    from pfc.alg.ppo_gru_hybrid_alg import PPO_GRU_HYBRID
    from pfc.agent.ppo_gru_hybrid_agent import Agent
